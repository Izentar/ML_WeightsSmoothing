...
if(__name__ == '__main__'):
    ...
    stat = sf.modelRun(sf.Metadata, dc.DefaultData_Metadata, dc.DefaultModel_Metadata, dc.DefaultDataMNIST, dc.DefaultModelPredef, dc.DefaultSmoothingOscilationGeneralizedMean, 
        obj, 
        load=False
        )
