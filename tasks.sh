...
# pole do modyfikacji
declare -a commands=(
    "python3 smoothing/experiment.py --model vgg19_bn --dataset CIFAR100 --optim SGD --loops 2 \
    ...
    "python3 smoothing/experiment.py --dev cuda:0 --model wide_resnet --depth 28 --widen-factor 10 --drop 0.3 \
    ...
    "python3 smoothing/experiment.py --dev cuda:0 --model densenet --depth 100 --growthRate 12 \
